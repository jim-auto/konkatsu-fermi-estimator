...
検索対象の性別、年齢、居住地、未婚、年収、身長、外見、スペ値、カップ数、経験人数などの条件を ON/OFF できます。条件を追加するたびに、母集団に対して仮定した割合を掛け合わせ、残存人数がグラフ上で減っていきます。

初期状態は「極端: 女性」のプリセットです。アラツー女性・都市部・未婚・外見上位10%・スペ値105以上・Eカップ・経験人数0人で、母集団がどれくらい残るかをすぐ確認できます。
