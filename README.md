...
検索対象の性別、年齢、居住地、未婚、年収、身長、外見偏差値、スペ値、カップ数、経験人数などの条件を ON/OFF できます。条件を追加するたびに、母集団に対して仮定した割合を掛け合わせ、残存人数がグラフ上で減っていきます。

初期状態は「極端: 女性」のプリセットです。10代後半〜20代前半女性・都市部・未婚・外見偏差値65以上・スペ値105以上・Eカップ・経験人数0人で、母集団がどれくらい残るかをすぐ確認できます。

## 例

「年収800万以上・身長175cm以上・10代後半〜20代前半・都市部・未婚」で絞ると、まず対象年齢の男性人口に減り、そこから未婚率、都市居住、年収、身長条件が順番に掛け合わされます。各条件は単体では現実的に見えても、複数を同時に満たす人数は急速に少なくなります。
...
- 外見偏差値、スペ値、カップ数、経験人数は特に仮定が強い条件です。
...
- 男女別に異なる分布を利用
- 年齢は最小/最大の年齢帯で範囲指定
- 女性検索時のスペ値、カップ数（Hカップ以上まで）、経験人数条件
